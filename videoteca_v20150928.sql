...
--
-- Servidor: localhost
-- Tiempo de generación: 28-09-2015 a las 23:51:20
...
('root', '[{"db":"videoteca","table":"PELICULAS"},{"db":"videoteca","table":"GENEROS"},{"db":"php_mvc","table":"posts"}]');
...
('root', '2015-08-29 11:35:02', '{"lang":"es"}');
--
...
(28, 'Ágora', 2009, 127, 'Alejandro AmenÃ¡bar', 21),
...
(54, 'El día de maÃ±ana', 2004, 124, 'Roland Emmerich', 16),
...
(141, 'La misión', 1986, 125, 'Roland JoffÃ©', 21),
