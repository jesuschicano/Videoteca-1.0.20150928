...
(9, 'Dos pÃ¡jaros a tiro', 1990, 110, 'John Badham', 1),
...
(16, 'Camino a la perdiciÃ³n', 2002, 117, 'Sam Mendes', 6),
...
(25, 'Estoy con los hipopÃ³tamos', 1979, 108, 'Italo Zingarelli', 5),
(26, '300', 2006, 117, 'Zack Snyder', 1),
(27, '55 dÃ­as en PekÃ­n', 1963, 154, 'Nicholas Ray, Guy Green', 8),
(28, 'Ãgora', 2009, 127, 'Alejandro AmenÃ¡bar', 21),
...
(53, 'El color pÃºrpura', 1985, 154, 'Steven Spielberg', 8),
(54, 'El dÃ­a de maÃ±ana', 2004, 124, 'Roland Emmerich', 16),
(55, 'El dÃ­a mÃ¡s largo', 1962, 178, 'Ken Annakin, Andrew Marton', 0),
(56, 'El guardaespaldas', 1992, 129, 'Mick Jackson', 8),
(57, 'El hobbit: Un viaje inesperado', 2012, 169, 'Peter Jackson', 20),
(58, 'El hombre de la mÃ¡scara de hierro', 1998, 132, 'Randall Wallace', 2),
...
(62, 'El niÃ±o con el pijama de rayas', 2008, 94, 'Mark Herman', 8),
...
(77, 'El rey leÃ³n', 1994, 89, 'Roger Allers, Rob Minkoff', 3),
(78, 'El seÃ±or de los anillos: La comunidad del anillo', 2001, 178, 'Peter Jackson', 20),
(79, 'El seÃ±or de los anillos: Las dos torres', 2002, 179, 'Peter Jackson', 20),
(80, 'El seÃ±or de los anillos: El retorno del rey', 2003, 201, 'Peter Jackson', 20),
(81, 'El silencio de los corderos', 1991, 118, 'Jonathan Demme', 17),
(82, 'El Ãºltimo mohicano', 1992, 112, 'Michael Mann', 2),
(83, 'El Ãºltimo samurÃ¡i', 2003, 154, 'Edward Zwick', 1),
...
(87, 'Enemigo mÃ­o', 1985, 108, 'Wolfgang Petersen', 16),
(88, 'Ã‰rase una vez en AmÃ©rica', 1984, 229, 'Sergio Leone', 6),
(89, 'EvasiÃ³n o victori', 1981, 116, 'John Huston', 1),
...
(103, 'Harry Potter y la cÃ¡mara secreta', 2002, 161, 'Chris Columbus', 20),
(104, 'Harry Potter y el prisionero de Azkaban', 2004, 142, 'Alfonso CuarÃ³n', 20),
(105, 'Harry Potter y el cÃ¡liz de fuego', 2005, 157, 'Mike Newell', 20),
(106, 'Harry Potter y la orden del fÃ©nix', 2007, 138, 'David Yates', 20),
(107, 'Harry Potter y el misterio del prÃ­ncipe', 2009, 153, 'David Yates', 20),
...
(110, 'Hasta que llegÃ³ su hora', 1968, 175, 'Sergio Leone', 19),
...
(136, 'La conspiraciÃ³n del pÃ¡nico', 2008, 118, 'D.J. Caruso', 17),
(137, 'La isla', 2005, 136, 'Michael Bay', 16),
(138, 'La leyenda del pianista en el ocÃ©ano', 1998, 165, 'Giuseppe Tornatore', 13),
(139, 'La lista de Schindler', 1993, 195, 'Steven Spielberg', 4),
(140, 'La milla verde', 1999, 189, 'Frank Darabont', 8),
(141, 'La misiÃ³n', 1986, 125, 'Roland JoffÃ©', 21),
(142, 'La momia', 1999, 125, 'Stephen Sommers', 2),
(143, 'La momia. La tumba del emperador dragÃ³n', 2008, 112, 'Rob Cohen', 2),
(144, 'La muerte tenÃ­a un precio', 1965, 132, 'Sergio Leone', 19),
(145, 'La pasiÃ³n de Cristo', 2004, 127, 'Mel Gibson', 8),
(146, 'La princesa Mononoke', 1997, 134, 'Hayao Miyazaki', 3),
(147, 'La vida es bella', 1997, 116, 'Roberto Benigni', 5),
(148, 'Lady HalcÃ³n', 1985, 121, 'Richard Donner', 2),
(149, 'Las crÃ³nicas de Narnia: El leÃ³n, la bruja y el armario', 2005, 143, 'Andrew Adamson', 20),
(150, 'Las crÃ³nicas de Narnia: El prÃ­ncipe Caspian', 2008, 150, 'Andrew Adamson', 20),
...
(154, 'Piratas del Caribe. La maldiciÃ³n de la Perla Negra', 2003, 143, 'Gore Verbinski', 2),
...
(169, 'NausicaÃ¤ del Valle del Viento', 1984, 117, 'Hayao Miyazaki', 3),
(170, 'Nicky, la aprendiz de bruja', 1989, 103, 'Hayao Miyazaki', 3),
(171, 'No es paÃ­s para viejos', 2007, 122, 'Ethan Coen, Joel Coen', 17),
...
(184, 'Robin Hood: PrÃ­ncipe de los ladrones', 1993, 143, 'Kevin Reynolds', 2),
...
(210, 'Sweeny Todd, el barbero diabÃ³lico de la calle Fleet', 2007, 116, 'Tim Burton', 13),
(211, 'Le seguÃ­an llamando Trinidad', 1971, 117, 'Enzo Barboni', 19),
(212, 'Cortocircuito', 1980, 98, 'John Badham', 5),
(213, 'DrÃ¡cula de Bram Stoker', 1992, 128, 'Francis Ford Coppola', 12),
(214, 'Sheena, reina de la selva', 1984, 117, 'John Guillermin', 2),
(215, 'Alguien volÃ³ sobre el nido del cuco', 1975, 133, 'Milos Forman', 8),
...
(219, 'Un papÃ¡ genial', 1999, 93, 'Dennis Dugan', 5),
...
(227, 'Â¡Viven!', 1993, 120, 'Frank Marshall', 4),
(228, 'El sueÃ±o de mi vida', 2004, 98, 'Gary Winick', 5),
...
(236, 'CÃ³mo entrenar a tu dragÃ³n', 2010, 98, 'Dean DeBlois, Chris Sanders', 3),
